...
import com.accela.mobile.http.volley.Legacy.ByteArrayBuffer;
...
abstract class AbstractMultipartForm {
    ...
    public AbstractMultipartForm(final String subType, final Charset charset, final String boundary) {
        super();
        ContentType.notNull(subType, "Multipart subtype");
        ContentType.notNull(boundary, "Multipart boundary");
